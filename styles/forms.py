...
class Banner_form(forms.ModelForm):
    class Meta:
        ...
        widgets = {"title":forms.TextInput(attrs={"class":"form-control my-2","placeholder":"Titulo del banner"}),
            ...
            "banner":forms.FileInput(attrs={"class":"form-control my-1","placeholder":"Imagen del banner (GRANDE)"}),
            "banner_2":forms.FileInput(attrs={"class":"form-control my-1","placeholder":"Imagen del banner 2 (GRANDE)"}),
            "banner_3":forms.FileInput(attrs={"class":"form-control my-1","placeholder":"Imagen del banner 3 (GRANDE)"}),
            ...
            "login_image":forms.FileInput(attrs={"class":"form-control my-1","placeholder":"Imagen del inicio de sesion"})}